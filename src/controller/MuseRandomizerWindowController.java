...
public class MuseRandomizerWindowController implements Initializable {
	...
	private void roll(ActionEvent event) {
		...
		for (int i = 0; i < count; i++) {
			...
			case 7:
				results.append("Roll ").append(i + 1).append(" result: ").append("Ray. Exact value: " + result)
						.append("\n");
				break;

			case 8:
				results.append("Roll ").append(i + 1).append(" result: ").append("Hadel. Exact value: " + result)
						.append("\n");
				break;

			case 9:
				if (cbCreatorJago.isSelected() && !cbStarfira.isSelected() && !cbJulie.isSelected()) {
					results.append("Roll ").append(i + 1).append(" result: ")
							.append("Creator!Jago. Exact value: " + result).append("\n");
				}
				...
				if (!cbCreatorJago.isSelected() && !cbStarfira.isSelected() && cbJulie.isSelected()) {
					results.append("Roll ").append(i + 1).append(" result: ").append("Julie. Exact value: " + result)
							.append("\n");
				}
				break;
